...
//if (bytes1[ctr] <= 85) { Console.WriteLine("Number: 0"); powerupID = 0; }
//else if (bytes1[ctr] >= 86 && bytes1[ctr] <= 190) { Console.WriteLine("Number: 1"); }
//else if (bytes1[ctr] >= 191) { Console.WriteLine("Number: 2"); }